                ...
                <div>
                    <ul className='flex gap-4 mr-16'>
                        <li className='text-xl'>
                            <NavLink className={(data) => data.isActive ? 'text-accent' : 'text-content'} to="/">Home</NavLink>
                        </li>
                        <li className='text-xl'>
                            <NavLink className={(data) => data.isActive ? 'text-accent' : 'text-content'} to="info" >Info</NavLink>
                        </li>
                    </ul>
